...
- **Phase 2実装時**: `04_CORE_ARCHITECTURE.md`, `08_PROMPT_DESIGN.md` を参照
- **Phase 3実装時**: `05_SERVICE_LAYER.md` を参照
- **Phase 4実装時**: `06_MCP_LAYER.md` を参照
...
2. **Phase 2**: コア機能（04_CORE_ARCHITECTURE.md）
3. **Phase 3**: サービス層（05_SERVICE_LAYER.md）
4. **Phase 4**: MCP層（06_MCP_LAYER.md）
...
2. **コア機能**: サービス層を呼び出してタスクを調整する、統一ReActエージェント
3. **サービス層**: コア層に呼び出されるビジネスロジックを実装
4. **MCP層**: サービス層に利用される、疎結合なツール群を提供
